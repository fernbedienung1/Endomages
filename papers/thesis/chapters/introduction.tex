...
As well as methods to find these \textit{noises} and remove them from the video data. In order to improve the endoscopic video which surgeons use to navigate during a surgery.\\
\newline
...
\section{Background}
    ...
    This surgical smoke interferes with a proper workflow, since in usual cases the smoke cannot leave a \textbf{\gls{Pneumoperitoneum}}. Although there exist multiple methods to remove this smoke physically, like suction or using electrical dispense systems a pure Software approach can make Sense. \\
...
\section{Intention}
    ...
    Therefore the first goal is the creation of video data to work with. \\
    \newline
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{pics/schmauch/realNoise.jpg}        % Cant use this one - get one of your owns
