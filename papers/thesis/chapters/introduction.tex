...
\section{Background}
    ...
    Based on a guest visit and observation of a laparoscopic surgery in the \textbf{\gls{ADK Blaubeuren}} with interviews to the surgeons, noises turned out to be one of the most impeding incidents.
...
\section{Intention}
    ...
    Focus of the mentioned approach is a combination of noise detection followed by selecting the right filter for the given noise. This aims to only modify the parts of the frames that actually contain noises. Furthermore multiple filters can be applied in different parts of the frame, to optimize the overall output.\\
    \newline

    \begin{figure}[h]
        \centering
        \includegraphics[scale=.19]{pics/schmauch/realNoise.jpg}
