	...
	The archived data will contain a set of \textbf{videos} and \textbf{images} that show \textit{noise}. This noise is defined by:\\
		\paragraph{surgical smoke \\} 
			Surgical smoke occurs when surgeons cauterize organs, veins or other body internal objects.
				Although its contents are mostly steam, there are multiple other particles dispensed within this kind of Fog and often also contains bacteria. The applied thermal energy of the cauter causes the tissues cells to explode. The exploding cell therefore releases its contents into the environment. \cite{contentOfSmoke} \\
...
\subsection{Removal}
    ...
    \paragraph{Histograms \\}
        Histograms describe the color composition of Pictures. This information can be used to compare pictures.
        They are a graphical representation of the count of colors in a picture. \\
        ...
        \begin{figure}[h]
            ...
            \begin{subfigure}[h]{0.5\textwidth}
                ...
                \caption{
                    Histogram of the based on Picture above\\
        ...
        Workflow of creating histograms is to count every pixels values and plot their count over the value \ref{fig:hist_example_hist}. The compleity of this problem is a 
        $$ O(n^3) $$ 
        problem, where $ n $ is the count of pixels in the Pictures \fuck{this is NOT TRUE}.\\
    ...
    \paragraph{Contrast Based \\}
        ...
        The main aspects of contrast help to detect \cite{detectSmoke}  and remove \cite{imageDehaze} smoke.\\
        ...
        \cmt{Picture of contrast enhancement and its outcome in a histogram}

    \paragraph{Dark Channel prior \\}
        Dark Channel Prior, which is a enhancement to the contrast based approach.
