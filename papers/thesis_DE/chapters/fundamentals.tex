...
\newpage
    ...
    \subsubsection{Kontrast \& Gamma \\}
        MATHE ÜR KONTRAST UND GAMMA KOMMT HIER REIN 
        aber das meinste kennst du ja schon vom immageick und python
        $$ g(x) = \alpha * f(x) + \beta $$
        in der gleichungsteht  $ i = zeile$ and $ j = spalte $ des Bildes mit RGB werten.\\ 
    ...
    \subsubsection{Dark Channel prior  \& Histogram Equalization\\}
        Der \gls{DCP} ist eine auf Kontrast basierende Erweiterung die Nebel und Rach aufgrund von geringen intensitäten in Farbkanälen 
        Ja, hier musst du nochmal deutlicher nachlesen...
