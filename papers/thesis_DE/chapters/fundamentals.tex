...
\section{Grundlagen laparoskopischer Eingriffe}
    ...
    Diese Eignung schließt bestimmte Aspekte ein, wie beispielsweise das langsame erscheinen von Verunreinigungen, definierte Bewegungen der Kamera,etc. \\
    \newline
	...
	\paragraph{\textbf{Mäuse} \textit{(Mus musculus)}\\}
        ...
        Mäuse sind jedoch für die Erstellung der Daten nicht geeignet, aus rein gründen.\\
    \fuck{Citations!}
	\newline
	...
	\paragraph{\textbf{Organe von Rindern} \textit{(Bos primigenius taurus)}\\}
        ...
        Die Verfügbarkeit sowie einfache Handhabung von Rinderinnerein  macht sie zu einem optimalen Kandidaten für erste Tests, insbesondere für die Erstellung von Laparoskopischen Trainern.\\
    \fuck{Citations!}
	\newline	 \\
	...
	\paragraph{Organe\\}
        Endoskope werden in verschiedenen Szenarien verwendet und durch verschiedenste Öffingen ins Körperinnere gebracht, 
        die in Deutschland und Europa meisten durchgeführten minimal invasiven Eingriffe stellen Cholezystektomien dar\fuck{CITATION}.\\
        Bei diesen Laparoskopien, sind Endoskope unverzichtbar, da sie die einzige Möglichkeit sind ins innere des Patienten zu sehen.
        \cmt{Endoskopie != Laparoskopie}\\
        Die entsprechend meist vorkommenden Bilder zeigen viszerale und andere abdominale Organe wie beispielsweise:
        ...
        Die Auswahl erfolgt auch hier, wie schon bei der Auswahl des Host-Tieres nach den Kriterien der Verfügbarkeit und des Realitätsaspektes.\\
        Weiterhin zu beachten ist bei der Selektion der Organe die Qualität bzw. die Frische.
    ...
    Ausserdem zeigen diese Video Aufnahmen reale Bewegungen des Endoskopes, des Patienten, sowie anderer Werkzeuge, etc.\\
    \newline
...
\subsection{Erkennung der Verschmutzungen}
    ...
    \paragraph{Rauch\\}
        ...
        Die Aufnahmen der Überwachungskameras werden hierfür einige Frames lang analisiert um die Ausbreitung des Rauches als Grundlage für dessen Erkennung zu verwenden.

    \paragraph{Dampf \& Beschlagen\\}
        Ein bisher vernachlässigtes Problem besteht im beschlagen der Kamera durch Dampf.\\
        Durch die bildung kleiner tropen verschwimmt das Bild und wird so unscharf. Das Erkennen von Unschärfe ist ein bereits wohlbekanntes Problem bei Kameras, wenn auch im Kontext der Scharfstellung von Bildern über Methoden des Automatischen Fokussierens.\\
        \cmt{Sources! - noch suchen!}
...
\newpage
    ...
    \subsubsection{Kontrast, Helligkeit \& Gamma \\}

    Kontrast, Helligkeit und Gamma werte sind typische Stellräder für die Bearbeitung von Bilddaten.
    Diese Anpassungen bestehen aus mathematischen Operationen die auf fertige Bilder angewandt werden, weswegen sie sich optimal für eine reine Softwarelösung eignen. \\
    Abbildung \ref{fig:contrastCurves} zeigt Veränderung der Histograme bei einer Anpassung der jeweiligen Stellgröße.
    
    \begin{figure}[H]
        \includegraphics[width=0.5\textwidth]{pics/net/Helligkeit_Kontrast_Gamma.png}
        \label{fig:contrastCurves}
        \caption{Histogramme für Helligkeit-, Kontrast-, und Gamma Anpassungen}
        %Das bild ist aus Wiki.....evtl bissle scheiße?
    \end{figure}

    Um die Bilder im entsprechenden Maße zu bearbeiten werden deren Histogramme an entsprechende Funktionen angeglichen.\\
    ...
    Beim Histogram matching 
    Der \gls{DCP} greift dieses Prinzip des Histogram matchings auf und konzentrieren sich hier auf den dunklen teil des Bildes, sprich die Pixel mit kleinen werten. \\


    \subsubsection{Raucherkennung}
