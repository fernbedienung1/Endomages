    ...
    \subsection{Kauterisierungsmethoden}
        ...
        \subsubsection{Diathermie}
            ...
            Diese Technik verwendet Elektroden die ähnlich dem schweißen am Körper angebracht werden um einen Stromfluss zu ermöglichen, welcher die Hitze erzeugt, die letztendlich zum Kauterisieren benötigt wird. Die Diathermie teilt sich auf zwei verschiedene Methoden auf: \\
                ...
                \end{figure}
            \paragraph{Monopolar}
                Beim Monopolaren\ref{fig:monopolar} arbeiten wird der Patient auf einer leitfähigen Unterlage positioniert, der strom fließt so von Elektrode durch den Körper des Patienten.
            ...
            Geräte wie der Caiman5 \cite{sealer} sind Bipolare einmal-Geräte speziell dafür konstruiert um Gewebe wie Adern zu greifen, dann zu kauterisieren und anschließend zu durchtrennen.
...
\subsection{der Verschmutzungen}
...
\subsection{Dark Channel Prior}
    \cmt{Bilder aus Papers wie in Praesi!}
