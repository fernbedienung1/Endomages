...
\subsubsection{Reale Daten}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{pics/usable_unsure/wolfVid.jpg}
        \caption{Aufnahme einer realen Laparoskopische Eingriffes}
        \label{fig:wolfVid}
    \end{figure}
...
\end{lstlisting}
    ...
    \subsection{Histogramme als Vergleichs Grundlage}
        ...
        \lstinputlisting[language=Python, caption={Histogram Generator Skript, Methode:calcHist}, label={code:histPY_calc}, firstline=22, lastline=44, xleftmargin=0.5cm]
        ...
        \lstinputlisting[language=Python, caption={Histogram Generator Skript, Methode:createCSV}, label={code:histPY_csv}, firstline=80, lastline=90, xleftmargin=0.5cm]
        {../../work/scripts/hist.py}
        \lstinputlisting[language=Python, caption={Histogram Generator Skript, Methode:histLong}, label={code:histPY_fun}, firstline=93, lastline=129, xleftmargin=0.5cm]
        {../../work/scripts/hist.py}
        ...
        Die Resultierenden CSV Dateien werden dann mittels des Scriptes \ref{code:collector} zusammengefasst.\\ 
        Gruppiert wird nach Quelle: ein Histogram beschreibt die Zusammensetzung aller Realen Daten die durch Uwe Widmaier\ref{uwe} aufgezeichnet wurden und ein weiteres über die Daten die im Laborversuch selbst erstellt wurden.\\
