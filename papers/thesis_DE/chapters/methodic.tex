...
Die hier beschriebenen Daten sind unter der DOI \url{10.6084/m9.figshare.7969367} \cite{myfuckigself} als Download unter GNU GPL 3.0 verfügbar \href{https://figshare.com/articles/2018-12-21-EndoscopicSmoke/7969367}{figshare}. 
    ...
    \subsubsection{Zweiter Prototyp}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{l|l|l|l}	%all left aligned
                ...
                \hline 
                Wolf & Prototyp & Lichtquelle & NONE \\
            \end{tabular}
        ...
        Da die organe von mehreren Tieren stammen wird darauf geachtet das nur jeweils zusammenpassende bzw. zusammenhängende organe gleichzeitig im Trainer verwendet werden.
...
\end{lstlisting}
    ...
    \subsection{Histogramme als Vergleichs Grundlage}
        ...
        \begin{figure*}[h]
            ...
            \end{subfigure}
            \caption{Ein und Ausgabe sowie Screenshot des Prozesses des Histogramgenerators}
            \label{fig:histInUse}
        \end{figure*}
