...
\section{Erkennen von Störungen}
\section{Entfernen von Störungen}

    \subsection{Dark Channel Prior}
    \subsection{Model Based Removal}
    \subsection{Chromaticity Based Removal}
    \subsection{Depth Estimates}

\section{Evaluation}
    \subsection{Eigene vs. Reale Daten}
    \subsection{Rauchentfernung}
    Hier sollte evtl ein bisschen CODE für die Histogramme rein kommen\\
    kannst was schreiben darüber das du keine Mediziner mehr hast die dir bei der eval helfen
    sowas halt....
