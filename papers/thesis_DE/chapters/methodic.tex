...
\subsubsection{Reale Daten}
    ...
    \begin{figure}[h]
        ...
        \caption{
            ...
            Werkzeug im Bild ist ein Elektrokauter.\\
        }
        \label{fig:wolfVid}
    \end{figure}
...
\end{lstlisting}
    ...
    \subsection{Helligkeit-, Gamma- und Kontrastanpassung}
        ...
        \subsection{Histogram Equalization}
            ...
            \newline
            Der unterschied der den immensen geschwindigkeits zuwachs ermöglicht ist hierbei nicht der wechsel der sprache, sondern der methodic.\\
