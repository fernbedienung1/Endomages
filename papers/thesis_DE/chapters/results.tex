\section{Testdaten Generierung}
    ...
    \subsection{Vergleich}
        ...
        \vspace{5cm}
         \hspace{5cm}   \paragraph{\textbf{\textsc{\textit{Weitere Results folgen in Druckversion}}}}
        \iffalse
        \begin{figure}[h]
            \includegraphics[width=\textwidth]{pics/net/vesicaBiliaris.png}
            % TODO - eins finden! - schlechtes licht + nahem zoom!
            \caption{Bild mit schlechtem Licht}
            \label{fig:closeup}
        \end{figure}
