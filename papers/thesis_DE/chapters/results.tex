\section{Testdaten Generierung}
    ...
    \subsection{Vergleich}
        ...
        Die Histogramme der Datensätze (Abb. \ref{fig:cumsum_mine} und \ref{fig:cumsum_real}) basieren daher nicht auf der selben Datenmenge.
        ...
        Das Histogram der selbst generierten Daten (Abb. \ref{fig:cumsum_mine}) gibt bereits Auskunft darüber wie die Bilder zusammengesetzt sind. Auffällig ist dass im sich die meisten Pixel im Bereich von Intensitäten $ < 50 $ befinden, dies deutet darauf hin dass die Bilder insgesamt Dunkel ausfallen. Ein Indiz für große Schwarzanteile der Bilder kann eine Häufung von Pixeln mit gleichem wert der Rot, Grün und Blau Anteile darstellen.\\
        ...
        Für zukünftige versuche ist jedoch zwingend an eine weitere oder bessere Lichtquelle zu denken, da dies mit unter zu den offensichtlichsten Unterschieden zu den realen Daten gehört. Darüber hinaus führt das fehlende Licht dazu dass das Endoskope sehr nah an die Organe und Werkzeuge gehalten werden muss. Dadurch ist der Platz begrenzt in dem sich der Rauch ausbreiten kann, die Einwirkungen des Dampfes sind wesentlich stärker und häufiger zu sehen und auch die Wahrscheinlichkeit der Tropfenbildung an der Kamera durch Spritzer ist wesentlich größer.\\
        \newline
        ...
        Generell hat das keine negativen Auswirkungen auf die Qualität des Schmauches, jedoch kommt es oft vor dass das Kamera Bild abrutscht, nicht direkt die Kauterisierte stelle zeigt oder wackelt. \\
        Auch dies sind keine direkten Nachteile, jedoch würden es viele dieser Bilder in realen Operationen dem Chirurgen nicht erlauben seiner Arbeit ordnungsgemäß nachzugehen.
