\section{Testdaten Generierung}
    ...
    \subsection{Vergleich}
        ...
        Vergleichend ist so festzustellen das die selbst generierten Daten dunkler sind als die realen Daten.\\
        ...
        Da die unzureichende Lichtquelle bereits bei der Erstellung der Daten als Problem erkannt wurde führte dies dazu dass die Aufnahmen der Organe mit geringen Abstand zum Objektiv aufgezeichnet wurden.\cmt{Bild?}\\
